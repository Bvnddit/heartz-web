...
function Blog() {
  return (
    <div>
  <a href='/DetalleBlog1'>
    <table className="table w-100" style={{backgroundColor: '#272727', borderRadius: '50px', border: 'none'}}>
      <tbody>
        <tr>
          <td style={{width: 500, backgroundColor: '#272727', borderRadius: '50px'}}>
            <img src={radioheadImg} alt width="500px" style={{borderRadius: '50px'}}/>
          </td>
          <td style={{display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', height: 250, backgroundColor: '#272727', borderRadius: '50px',  borderBottom: 'none'}}>
  ...
  <a href='/DetalleBlog2'>
    <table className="table w-100" style={{backgroundColor: '#272727', borderRadius: '50px', border: 'none'}}>
      <tbody><tr>
          <td style={{width: 500, backgroundColor: '#272727', borderRadius: '50px'}}>
            <img src={gamImg} alt width="500px" style={{borderRadius: '50px'}}/>
          </td>
          <td style={{display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', height: 250, backgroundColor: '#272727', borderRadius: '50px', borderBottom: 'none'}}>
